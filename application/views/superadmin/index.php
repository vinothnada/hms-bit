            ...
            <main id="main-container">
                <!-- Page Header -->
                <div class="bg-image overflow-hidden" style="background-image: url('<?= base_url(); ?>assets/img/photos/photo31@2x.jpg');">
                ...
                <div class="content content-narrow">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <!-- Add Friend -->
                            <div class="bg-image" style="background-image: url('<?= base_url(); ?>assets/img/photos/photo29.jpg');">
                                <div class="bg-black-op">
                                    <div class="block block-themed block-transparent">
                                        ...
                                        <div class="block-content text-center">
                                            <div class="push">
                                                <img class="img-avatar img-avatar96 img-avatar-thumb" src="<?= base_url(); ?>assets/img/avatars/avatar10.jpg" alt="">
                                            </div>
                        ...
                        <div class="col-lg-4">
                            <!-- Category -->
                            <div class="bg-image" style="background-image: url('<?= base_url(); ?>assets/img/photos/photo28.jpg');">
                                <div class="bg-black-op">
                                    <div class="block block-themed block-transparent">
                                        <div class="block-header">
                                            <ul class="block-options">
                        ...
                        <div class="col-lg-4">
                            <!-- Weather -->
                            <div class="block">
                                <div class="bg-image" style="background-image: url('<?= base_url(); ?>assets/img/photos/photo33.jpg');">
                                    <div class="bg-black-op">
                                        <div class="block-content text-center">
