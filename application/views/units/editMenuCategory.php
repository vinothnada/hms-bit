            ...
            <div class="col-lg-12">
                ...
                <div class="block block-themed">
                    <div class="block-header bg-primary">
                        ...
                        <h3 class="block-title">Update Menu Item</h3>
                    </div>
                    <div class="block-content">                                            
                            <form class="js-validation-form form-horizontal push-10-t push-10"
                                action="<?=site_url("units/editMenuCategory")?>" method="post">
                            <div class="form-group">
                                <div class="col-xs-6">
                                    <div class="form-material">
                                        <input class="form-control" type="text" id="name"
                                               name="name" placeholder="Please fill name" value="<?= $menucategory[0]->name;?>">
                                ...
                                <div class="col-xs-6">
                                    <div class="form-material">
                                        <select class="form-control" id="status"
                                                name="status">
                                            <option value="Active"
                                            <?php if ($menucategory[0]->status == 'Active') { echo "selected = 'selected'";} ?>
                                             >Active</option>
                                            <option value="Blocked"
                                            <?php if ($menucategory[0]->status == 'Blocked') { echo "selected = 'selected'";} ?>
                                            >Blocked</option>
