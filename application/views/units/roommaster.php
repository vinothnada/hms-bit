...
<div class="block">
	<div class="block-header">
		<div class="block-options">
          ...
          <?php $this->session->set_userdata('csvdata',$roommaster); ?>
              &nbsp;
        <a href="<?= site_url("reports/exportRoommaster") ?>"><button class="btn btn-sm btn-danger pull-right" type="button" id="cid" ><i class="fa fa-file-pdf-o"></i>&nbsp; Export CSV</button></a>
      </div>
  </div>
